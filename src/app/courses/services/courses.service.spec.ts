...
describe('CoursesService', () => {
  ...
  it('should retrieve all courses', () => {
    coursesService.findAllCourses()
      .subscribe(courses => {
        ...
        const currentCourse = courses.find((course => course.id === 12));
        expect(currentCourse.titles.description).toBe('Angular Testing Course');
      });
  ...
  it('should find a course by id', () => {
    coursesService.findCourseById(12)
      .subscribe(course => {
        ...
        expect(course.id).toBe(12, 'Incorrect number of id');
      });
  ...
  it('should save the course date', () => {
